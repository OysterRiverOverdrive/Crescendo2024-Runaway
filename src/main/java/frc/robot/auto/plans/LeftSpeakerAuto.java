  ...
  public LeftSpeakerAuto(
    ...
    Command LeftShoot =
        autodrive.AutoDriveCmd(
            drivetrain, List.of(new Translation2d(0, 0)), new Pose2d(0, 0, new Rotation2d(Math.PI/2 + 0.1328*Math.PI)));
    ...
    addCommands(
        ...
        // Shooter Sequential
        new SequentialCommandGroup(new AutoShooterCmd(shooter, 1, 0.8, 3)));
  }
}
