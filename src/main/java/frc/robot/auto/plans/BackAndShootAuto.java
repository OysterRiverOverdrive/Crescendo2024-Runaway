  ...
  public BackAndShootAuto(
    ...
    Command speakerForwards =
        autodrive.AutoDriveCmd(
            drivetrain, List.of(new Translation2d(0.2, 0)),
            new Pose2d(0.45, 0, new Rotation2d(0)));

    Command taxi = autodrive.AutoDriveCmd(drivetrain,
    ...
    addCommands(
        ...
        new SequentialCommandGroup(speakerForwards,new AutoSleepCmd(4),taxi),
